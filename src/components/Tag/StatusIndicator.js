...
export default function StatusIndicator({ currentTag }) {
  ...
  let imageSrcModal, imageSrcModal2;
  if (currentTag) {
    imageSrcModal = currentTag.imageSrcModal;
    imageSrcModal2 = currentTag.imageSrcModal2;
  }
  ...
  return (
    <Flex justifyContent="center" alignItems="center" h="216px" w="full" flexDir="column" overflow="hidden" position="relative">
      ...
      <Box
        ...
        backgroundImage={`url(${imageSrcModal})`}
        _before={{
          content: "''",
          position: 'relative',
          display: 'block',
      ...
      <Box
        ...
        backgroundRepeat="no-repeat"
        backgroundPosition="center"
        backgroundImage={`url(${imageSrcModal2})`}
...
//         backgroundRepeat="no-repeat"
//         backgroundPosition="center"
//         backgroundImage={`url(${tag.imageSrcModal})`}
//         _before={{
//           content: "''",
//           position: 'relative',
//           display: 'block',
...
//         backgroundRepeat="no-repeat"
//         backgroundPosition="center"
//         backgroundImage={`url(${tag.imageSrcModal2})`}
//         mt="2em" // Aumentando a distância entre os círculos
//       />
//     </Flex>
//   );
